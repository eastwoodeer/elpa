...
(register-definition-prefixes "config" '("my-" "shrface-nov-setup"))
...
This is a minor mode.  If called interactively, toggle the `Shrface
...
evaluate the variable `shrface-mode'.
