...
This is a minor mode.  If called interactively, toggle the `Org-Remark
...
evaluate the variable `org-remark-mode'.
...
`Org-Remark-Eww mode' mode.  If the prefix argument is positive, enable
...
This is a global minor mode.  If called interactively, toggle the
`Org-Remark-Global-Tracking mode' mode.  If the prefix argument is
...
`Org-Remark-Icon mode' mode.  If the prefix argument is positive, enable
the mode, and if it is zero or negative, disable the mode.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `org-remark-icon-mode'.
...
This is a global minor mode.  If called interactively, toggle the
`Org-Remark-Info mode' mode.  If the prefix argument is positive, enable
the mode, and if it is zero or negative, disable the mode.
...
This is a minor mode.  If called interactively, toggle the
`Org-Remark-Line mode' mode.  If the prefix argument is positive, enable
the mode, and if it is zero or negative, disable the mode.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `org-remark-line-mode'.
...
This is a global minor mode.  If called interactively, toggle the
`Org-Remark-Nov mode' mode.  If the prefix argument is positive, enable
the mode, and if it is zero or negative, disable the mode.
